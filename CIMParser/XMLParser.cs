    ...
    internal class XMLParser
    {
        public static IHandler DoParse(IHandler handler, Stream stream, string fileName, out bool success, out TimeSpan durationOfParsing)
        {
            ...
            try
            {
                ...
                {
                    DtdProcessing = DtdProcessing.Parse, //ADDED BY MKM TO DISABLE DTD WARNING //Description: For security reasons DTD is prohibited in this XML document. To enable DTD processing set the DtdProcessing property on XmlReaderSettings to Parse and pass the settings into XmlReader.Create method.
                    ValidationType = ValidationType.DTD, //ADDED BY MKM TO DISABLE DTD WARNING
                    IgnoreComments = true,
