...
namespace CIM.Model
{
    public class ConcreteModelBuilder
    {
        ...
        public string ActiveNamespace => activeNamespace;
                        ...
                        if (idObjectPair.Value != null)
                        {
                            if (!(bool)hasValueProp.GetValue(idObjectPair.Value, null))
                            {
                                ...
                                if (firstOccurance)
                                {
                                    ...
                                    if (missingValuesMap.ContainsKey(idObjectPair.Key))
                                    {
                                        if (!missingValuesMap[idObjectPair.Key].Contains(propertyName))
                                        {
                                            missingValuesMap[idObjectPair.Key].Add(propertyName);
                                        }
                                    }
                                    else
                                    {
                                        missingValuesMap.Add(idObjectPair.Key, new List<string>() { propertyName });
                                    }
        ...
        {
            if (type.Equals(typeof(System.DateTime)) || type.Equals(typeof(string)) || type.Equals(typeof(int)) || type.Equals(typeof(float)) || type.Equals(typeof(double)) || type.Equals(typeof(bool))
                || type.Equals(typeof(System.DateTime?)) || type.Equals(typeof(int?)) || type.Equals(typeof(float?)) || type.Equals(typeof(double?)) || type.Equals(typeof(bool?))
                )
            {
                return true;
            }
