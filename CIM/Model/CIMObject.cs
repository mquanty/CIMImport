...
namespace CIM.Model
{
    ...
    public class CIMObject
    {
        ...
        {
            get => isDefinedAsEmbedded;
            set => isDefinedAsEmbedded = value;
        }
        ...
        {
            get => sourceStartColumn;
            set => sourceStartColumn = value;
        }
        ...
        {
            get => embeddedParentId;
            set => embeddedParentId = value;
        }
        ...
        {
            get => isInstanceOfType;
            set => isInstanceOfType = value;
        }
        ...
        /// </summary>
        public List<string> ValidationMessages => validationMessages;
        ...
        public void RemoveAttribute(string fullName, int index)
        {
            ...
            if (myAttributes != null)
            {
                if (myAttributes.ContainsKey(attributeCode))
                {
                    myAttributes.TryGetValue(attributeCode, out List<ObjectAttribute> attrList);
        ...
        public void RemoveAttribute(ObjectAttribute objectAttribute)
        {
            if ((myAttributes != null) && (objectAttribute != null))
            {
                ...
                {
                    myAttributes.TryGetValue(objectAttribute.Code, out List<ObjectAttribute> attrList);
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                eq = (string.Compare(ID, ((obj as CIMObject).ID)) == 0);
            }
            return eq;
        }
