    ...
    public class Profile
    {
        ...
        public int PackageCount
        {
            get
            {
                ...
                if (profileMap != null)
                {
                    profileMap.TryGetValue(ProfileElementTypes.ClassCategory, out List<ProfileElement> elements);
                    if (elements != null)
                    {
        ...
        public int ClassCount
        {
            get
            {
                ...
                if (profileMap != null)
                {
                    profileMap.TryGetValue(ProfileElementTypes.Class, out List<ProfileElement> elements);
                    if (elements != null)
                    {
                        count = elements.Count;
                    }
        ...
        public int PropertyCount
        {
            get
            {
                ...
                if (profileMap != null)
                {
                    profileMap.TryGetValue(ProfileElementTypes.Property, out List<ProfileElement> elements);
                    if (elements != null)
                    {
                        count = elements.Count;
                    }
        ...
        public int StereotypeCount
        {
            get
            {
                ...
                if (profileMap != null)
                {
                    profileMap.TryGetValue(ProfileElementTypes.Stereotype, out List<ProfileElement> elements);
                    if (elements != null)
                    {
                        count = elements.Count;
                    }
