...
namespace CIM.Specific
{
    ...
    internal class CIMRDFComparerXMLHandler : DefaultXMLHandler
    {
        ...
        /// </summary>
        public CIMModelSets Model => model;

        public string Start => xmlBegining;
            ...
            if (string.Compare(rdfRoot, type, true) != 0)
            {
                ...
                if (currentElement == null)
                {
                    if (id != null)
                    {
                        ...
                        {
                            RdfID = StringManipulationManager.ExtractAllAfterSeparator(id, StringManipulationManager.SeparatorSharp),
