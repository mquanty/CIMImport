...
namespace CIM.ModelCompare
{
	public class CIMModelSets
	{
        ...
        {
            get => modelSourcePath;
            set => modelSourcePath = value;
        }

        public SortedList<string, CIMEntity> ModelMRID => modelMRID;

        public SortedList<string, CIMEntity> ModelRDFID => modelRDFID;

        public SortedList<string, CIMEntity> ModelRDFIDFull => modelRDFIDFull;
